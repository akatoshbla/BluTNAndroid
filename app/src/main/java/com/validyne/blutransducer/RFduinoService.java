...
public class RFduinoService extends Service {
    ...
    public final static ParcelUuid PUUID_SERVICE = BluetoothHelper.sixteenBitPUuid(0x2220);
    public final static ParcelUuid PUUID_RECEIVE = BluetoothHelper.sixteenBitPUuid(0x2221);
    public final static ParcelUuid PUUID_SEND = BluetoothHelper.sixteenBitPUuid(0x2222);
    public final static ParcelUuid PUUID_DISCONNECT = BluetoothHelper.sixteenBitPUuid(0x2223);
    public final static ParcelUuid PUUID_CLIENT_CONFIGURATION = BluetoothHelper.sixteenBitPUuid(0x2902);
